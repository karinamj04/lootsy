...
<head>
  ...
  <link rel="stylesheet" href="ProjetoFaculdade/styles/index.css"/>
  <link rel="stylesheet" href="ProjetoFaculdade/styles/banner.css"/>
  <link rel="stylesheet" href="ProjetoFaculdade/styles/footer.css"/>
  <link rel="shortcut icon" href="ProjetoFaculdade/assets/images/imagem_da_logo.png" type="image/x-icon">
</head>
...
<header> 
    <div class="icone">
       <a href="/Projeto-back-end-main/home.php">
   ...
   <div class="header-buttons">
     ...
     <div class="cart-button">
      <img src="ProjetoFaculdade/assets/images/carrinho-compras.png" alt="Carrinho">
    ...
    <nav class="navbar">
        <ul class="nav-links">
  <li><a href="/Projeto-back-end-main/home.php">Página Inicial</a></li>    
...
<section class="banner">
  <div class="carousel">
    <div class="slides">
      <img src="ProjetoFaculdade/assets/images/banner1.png" class="slide active" alt="Promoção de jogos da Lootsy - Banner 1"/>
      <img src="ProjetoFaculdade/assets/images/banner2.png" class="slide" alt="Promoção de jogos da Lootsy - Banner 2"/>
      <img src="ProjetoFaculdade/assets/images/banner3.png" class="slide" alt="Promoção de jogos da Lootsy - Banner 3"/>
    </div>
  </div>
...
<!--- Hero banner -->
  ...
  <section class="loot-banner"> 
    <div class="banner-content">
      ...
      <div class="imagem-wrapper">
       <img src="ProjetoFaculdade/assets/images/icone02.png" loading="lazy" alt="Loot"  />
      </div>
   </div>
 </section>
  </section>
 ...
 <!--- Compra garantida e formas de pagamentos -->
  ...
  <div class="bloco-texto-e-icon">
    <div class="icon">
      <img src="ProjetoFaculdade/assets/images/compra-ok.png" loading="lazy" alt="Ícone Garantia" />
    </div>
    <div class="texto">
  ...
  <div class="pagamentos">
    <img src="ProjetoFaculdade/assets/images/pix.png" loading="lazy" alt="Pix"/>
    <img src="ProjetoFaculdade/assets/images/boleto.png" loading="lazy" alt="Boleto"/>
    <img src="ProjetoFaculdade/assets/images/cartao.png" loading="lazy" alt="Cartão de Crédito"/>
 </div>
  </section>
    </main>
  ...
  <footer class="footer">
    <div class="footer-container">
      ...
      <div class="contato-social">
        <div class="logo">
          <img src="ProjetoFaculdade/assets/images/logo+nome.png" loading="lazy" alt="Logo Lootsy">
          <p>AV. PARIS, 84 · (21) 3882-9797</p>
        </div>
        <div class="social-icons">
          <img src="ProjetoFaculdade/assets/images/redes.png" loading="lazy" alt="Redes">
        </div>
      </div>
    </div>
    ...
    <div class="footer-bottom">
      <div class="selos">
        ...
        <img src="ProjetoFaculdade/assets/images/google-secure.png" loading="lazy" alt="Google Site Seguro">
        <img src="ProjetoFaculdade/assets/images/ssl-secure.png" loading="lazy" alt="SSL Encryption">
      </div>

      <div class="envio">
        <h3>Formas de Envio:</h3>
        <img src="ProjetoFaculdade/assets/images/envios_correios.webp" loading="lazy" alt="Correios SEDEX e PAC">
      </div>
    </div>
